...
function App() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800">
      {/* Header */}
      <header className="border-b border-blue-800/30 bg-slate-900/90 backdrop-blur-sm sticky top-0 z-50">
        <div className="w-full px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white">BrainNet</h1>
                <p className="text-sm text-blue-200">Neural Network Analysis Platform</p>
              </div>
            </div>
            
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                <span className="text-sm font-medium text-blue-200">Flywire</span>
                <Switch />
                <span className="text-sm font-medium text-blue-200">Neuprint</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <main className="w-full px-4 py-8">
        <div className="w-full">
          ...
          <div className="bg-slate-800/80 border border-blue-700/30 rounded-2xl shadow-2xl p-8 mb-8 hover-lift animate-fade-in-up max-w-4xl mx-auto">
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  <label htmlFor="rootId" className="block text-sm font-medium text-blue-200 mb-2">
                    Root ID
                  </label>
            ...
            <div className="bg-slate-800/80 border border-blue-700/30 rounded-2xl shadow-2xl p-8 animate-fade-in-up w-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {Object.entries(neuronInfo).map(([key, value]) => (
                  <div key={key} className="bg-slate-700/50 border border-blue-600/20 rounded-lg p-4 hover-lift transition-all duration-200">
                    <h4 className="font-medium text-blue-200 mb-2 capitalize">
          ...
          <div className="mt-12 max-w-4xl mx-auto">
            <NavigationMenu className="bg-slate-800/80 border border-blue-700/30 rounded-xl shadow-lg hover-lift">
              <NavigationMenuList>
                <NavigationMenuItem>
                  <NavigationMenuTrigger className="text-white dark:text-white">
                    Data Sources
                  </NavigationMenuTrigger>
                  <NavigationMenuContent>
      ...
      {/* Footer */}
      <footer className="border-t border-blue-800/30 bg-slate-900/90 backdrop-blur-sm mt-16">
        <div className="w-full px-4 py-8">
          <div className="text-center text-blue-200">
            <p>&copy; 2025 Rishabh Sabnavis in Hattori Lab @ UT Southwestern. Built for neural network analysis.</p>
          </div>
        </div>
      </footer>
    </div>
